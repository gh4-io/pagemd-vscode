    ...
    [
      {
        label: 'Project',
        value: 'project',
        description: 'Initialize a new PageMD project (Recommended)',
        picked: true,
      },
      {
        label: 'Profile',
        value: 'profile',
        description: 'Create a profile manifest (Not fully implemented)',
      },
      {
        label: 'Markdown',
        value: 'markdown',
        description: 'Create a markdown file (Not fully implemented)',
      },
      {
        label: 'Style',
        value: 'style',
        description: 'Create a style file (Not fully implemented)',
      },
    ],
    {
...
async function executeInit(
  ...
  try {
    ...
    if (result.code === 0) {
      ...
      const createdPath =
        type === 'project'
          ? path.join(outputDir, name, 'README.md')
